...
namespace UsefullPatches
{
    internal static class ConfigManager
    {
        ...
        private static string cFarming = "Farming";
        ...
        public static ConfigEntry<int>? PetDailyFriendshipGain;
        public static ConfigEntry<bool>? DisableAnimalSickness;

        // ### Farming ###
        public static ConfigEntry<int>? FarmingExperienceIncrease;
        ...
        public static ConfigEntry<int>? FishingExperienceIncrease;
        ...
        public static void Init(ConfigFile config)
        {
            ...
            // ### Farming ###
            FarmingExperienceIncrease = config.Bind(cFarming, "FarmingExperienceIncrease", -1, " Increases the farming (trees & harvastables) experience/optained count. !!Experimental!!\n -1 Disabled.\n value > 1 = more experience.\n A value of the 2 would double your experience gained per fruit/harvestable, value of 3 triple, and so on.\n Use int numbers (1).");
            ...
            FishingExperienceIncrease = config.Bind(cFishing, "FishingExperienceIncrease", -1, " Increases the fish experience/optained count. !!Experimental!!\n -1 Disabled.\n value > 1 = more experience.\n A value of the 2 would double your experience gained per fish, value of 3 triple, and so on.\n Use int numbers (1).");
